-- Fix the secure Move Tenant RPC activity-log role type.
-- profiles.role and activity_logs.user_role both use public.app_role;
-- keep the enum value instead of converting it to text.
