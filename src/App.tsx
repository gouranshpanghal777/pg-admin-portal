...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f3ec] text-slate-900">
      ...
      {modal === 'accountEntry' && <UnifiedLedgerEntryModal branch={branch} categories={data.categories.filter((category) => category.branchId === branchId)} parties={scoped.ledgerParties} onClose={closeModal} onSubmit={(entry) => {
